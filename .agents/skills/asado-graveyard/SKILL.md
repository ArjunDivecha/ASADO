...
> **Why this skill exists.** Re-proposing a dead end is the fastest way to lose the user's trust (AGENTS.md "Quant Research Guardrail"). Autonomous agents in this repo have a documented habit of re-deriving things the record already settled, and of "discovering" passes that don't survive honest re-derivation. Check the record first.
