...
`loop_daily_job.py` docstring saying 37 and `AGENTS.md` saying ~33 are **both stale** — do not
...
# Other collectors (existence-verified; see AGENTS.md "Commands that work"):
...
**MCP server** (`scripts/asado_mcp_server.py`) — stdio server for Codex Desktop ("use ASADO").
