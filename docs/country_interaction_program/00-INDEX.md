...
| 02 | v1 feature retirement + gate-roster v2 | 0 | SONNET (STOP branch → OPUS) | 01 | **DONE 2026-08-24** — re-arm SURVIVES the PIT surface (v2 = re-armed, consec 2); 14/318 historical gate-months differ |
