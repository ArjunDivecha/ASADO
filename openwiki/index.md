...
- [Frontend and cockpit](frontend-and-cockpit.md) - ASADO's user-facing surfaces: the Chief-of-Staff cockpit payload contract and producer, the Streamlit research dashboard, the Perspective Lab workbench, and the monthly-update SSE backend — plus the distinction between verified signals and conjecture.
- [Loop and research workflows](loop-and-research.md) - ASADO's nightly alpha-hunting loop: dislocation engine, Price-Discovery Gap Engine, ledgers, harness verdicts, calibration reports, Triptych priors, graph features, the Learning Loop (gap-outcome scoring + attribution + Fable claims), and the canonical nightly brief.
