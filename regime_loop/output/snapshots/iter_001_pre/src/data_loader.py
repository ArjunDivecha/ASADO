...
=============================================================================
INPUT:
- Data/asado.duckdb (t2_master, extended_factors, bloomberg_factors)
- FRED API (macro regime indicators, cached under regime/data/raw/)

OUTPUT:
- Processed parquet panels for factors, returns, macro state
=============================================================================
"""
