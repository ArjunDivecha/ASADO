...
"""
=============================================================================
SCRIPT NAME: build_country_signals.py
=============================================================================

INPUT FILES:
- /Users/arjundivecha/Dropbox/AAA Backup/A Complete/GDELT/data/country_day/*.parquet
    Per-day country aggregate parquet files (default for --country-day-dir)
- /Users/arjundivecha/Dropbox/AAA Backup/A Complete/GDELT/data/manifests/country_day/*.json
    Optional manifest JSON files for fetch coverage metadata (default for --manifest-dir)

OUTPUT FILES:
- /Users/arjundivecha/Dropbox/AAA Backup/A Complete/GDELT/data/panels/country_signal_daily.csv
    Combined signal panel CSV with raw components and composite indicators
- /Users/arjundivecha/Dropbox/AAA Backup/A Complete/GDELT/data/panels/country_signal_daily.parquet
    Combined signal panel parquet with raw components and composite indicators
...
Computes trailing z-scores, attention shock, and raw signal components for each
country, then writes the combined panel to CSV and parquet formats.
...
USAGE:
    python build_country_signals.py
    python build_country_signals.py --country-day-dir <path> --output-csv <path> --output-parquet <path>

NOTES:
- Default paths are relative to the GDELT project root.
- attention_shock and composite indicators are trailing-window signals.
- They are intentionally blank until there is enough history for a country.
- Expanding to calendar days is optional via --observation-windows.
=============================================================================
"""
