...
com.arjundivecha.asado-loop-daily) in this order:
  ...
  9. collect_sovereign_daily_bbg - Bloomberg daily 5Y CDS (20 countries) +
                            10Y yields (32) -> sovereign_daily.parquet
                            (OpusBloomberg conda env, parquet only)
 10. load_sovereign_daily  - rebuild loop-DB sovereign_daily from the parquet
